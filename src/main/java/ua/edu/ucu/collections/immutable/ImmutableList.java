...
public interface ImmutableList {
    ...
    ImmutableList addAll(Object[] c); //додає масив елементів
    // у кінець колекції

    ImmutableList addAll(int index, Object[] c); // додає масив елементів
    // починаючи з зазначеного індекса, та кидає виключну ситуацію, якщо і
    // ндекс виходить за межі колекції
